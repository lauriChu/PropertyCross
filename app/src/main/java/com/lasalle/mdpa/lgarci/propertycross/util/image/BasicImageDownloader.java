package com.lasalle.mdpa.lgarci.propertycross.util.image;

/**
 * Created by lgarcia on 19/5/16.
 */
...
public class BasicImageDownloader {
     ...
     * @since 1.1
     */
    public static void readFromDiskAsyncSampled(@NonNull File imageFile, final int height, final int width, @NonNull final OnImageReadListener listener) {
        new AsyncTask<String, Void, Bitmap>() {
            @Override
            protected Bitmap doInBackground(String... params) {
                try {
                    return BitmapFactoryManagement.decodeSampledBitmapFromFile(params[0], height, width);
